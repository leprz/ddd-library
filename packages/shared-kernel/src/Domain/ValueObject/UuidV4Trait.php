...
use Library\SharedKernel\Domain\Exception\InvalidArgumentException;
...
trait UuidV4Trait
{
    ...
    /**
     * @param string $uuid
     * @throws \Library\SharedKernel\Domain\Exception\InvalidArgumentException
     */
    ...
    protected static function assertUuidFormat(string $uuid): void
    {
        if (!self::isUuidValid($uuid)) {
            throw new InvalidArgumentException(
                sprintf("Uuid [%s] is invalid", $uuid)
            );
        }
    }
